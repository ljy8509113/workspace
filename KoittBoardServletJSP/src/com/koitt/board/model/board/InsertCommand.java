...
public class InsertCommand implements Command {
	...
	@Override
	public String execute(HttpServletRequest req, HttpServletResponse resp) throws ClassNotFoundException, SQLException, NumberFormatException {
		// 1. 포워딩할 JSP 페이지명
...
//		Integer userNo = Integer.parseInt(req.getParameter("user_no")); //req.getParameter("writer");
		String email = req.getParameter("email");
		
		UsersDao userDao = new UsersDao();
		Users user = userDao.select(email);
